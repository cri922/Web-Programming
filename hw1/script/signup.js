...
function checkEmail(){
  ...
  if(email!==""){
    ...
    if(email.match(regex)){
      ...
      fetch("/hw1/ajax/ajax_check_email.php?email="+encodeURIComponent(email)).then(onResponse).then(onEmailJson);
    }else{
...
function checkUsername(){
  ...
  if(username!==""){
    ...
    if(username.match(regex)){
      ...
      fetch("/hw1/ajax/ajax_check_username.php?username="+encodeURIComponent(username)).then(onResponse).then(onUsernameJson);
    }else{
